...
import 'package:lospescaditosdmary/src/pages/admin/orders/detail/admin_orders_detail_controller.dart';
...
AdminOrdersDetailController _con = new AdminOrdersDetailController();
  ...
  Widget _textDescription() {
    return Container(
      ...
      child: Text(
        _con.order.status == 'PEDIDO' ? 'Asignar repartidor' : 'Repartidor asignado',
        style: TextStyle(
