...
import 'package:lospescaditosdmary/src/pages/customer/orders/create/customer_orders_create_controller.dart';
...
class CustomerOrdersCreatePage extends StatefulWidget {
  const CustomerOrdersCreatePage({ Key key }) : super(key: key);

  @override
  _CustomerOrdersCreatePageState createState() => _CustomerOrdersCreatePageState();
}

class _CustomerOrdersCreatePageState extends State<CustomerOrdersCreatePage> {

  CustomerOrdersCreateController _con = new CustomerOrdersCreateController();
